  ...
  <body>
    ...
    <div class="content">
      ...
      <div class="login-page">
        <div class="form">
        <a href= "login.php"><i class="bi bi-arrow-left-square-fill" style="position:absolute; left: 12px; top: 2px; font-size: 3rem; color: #804d00;" ></a></i>
      ...
      <?php 
        ...
        $db = mysql_select_db('sospatinhas');
          if (isset($entrar)) {
            ...
            $verifica = mysql_query("SELECT * FROM instituicao WHERE email = 'email' AND senha = '$senha'") or die("erro ao selecionar");
