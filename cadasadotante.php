  ...
  <body>
    ...
    <!--FIM CODIGO MORTO-->
          <form class="login-form">
            ...
            <input type="password" id= "senha" placeholder="Senha"/>
            <button>cadastrar</button>
            <p class="message">Já é cadastrado? <a href="adotante.php"> Entre aqui!</a></p>
          </form>
        </div>
      </div>
      ...
      <?php 
        ...
        $query_select = "SELECT email FROM adotante WHERE email = '$email'";
          ...
          if($email == "" || $email == null){
            echo"<script language='javascript' type='text/javascript'>alert('O campo email deve ser preenchido');window.location.href='cadastro.html';</script>";
              ...
              if($logarray == $email){
                ...
                $query = "INSERT INTO adotante (email,senha) VALUES ('$email','$senha')";
